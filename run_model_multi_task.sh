...
do
   ...
   bazel-bin/cabby/model/text/model_trainer  --data_dir /mnt/hackney/human_data/landmarks_data --dataset_dir /mnt/hackney/human_data/fixedlandmarks  --region Manhattan --s2_level 18 --output_dir /mnt/hackney/rvs/multitask/18 --test_batch_size 64 --num_epochs 1 --task human_points --model S2-Generation-T5-Landmarks --model_path /mnt/hackney/rvs/multitask/18/model.pt --is_val_loss_from_model True --is_single_sample_train True
...
bazel-bin/cabby/model/text/model_trainer  --data_dir /mnt/hackney/human_data/landmarks_data --dataset_dir /mnt/hackney/human_data/fixedlandmarks  --region Manhattan --s2_level 18 --output_dir /mnt/hackney/rvs/multitask/18  --train_batch_size 16  --test_batch_size 64 --num_epochs 1 --task human_points --model S2-Generation-T5-Landmarks --model_path /mnt/hackney/rvs/multitask/18/model.pt --is_val_loss_from_model True